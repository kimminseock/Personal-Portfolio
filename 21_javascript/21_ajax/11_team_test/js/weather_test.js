document.addEventListener('DOMContentLoaded', function () {
    ...
    const btn3 = document.querySelector('header div:nth-of-type(1) button:nth-of-type(3)');
    ...
    btn1.addEventListener('click', function () {
        ...
        function callBack(obj) {
            ...
            items.forEach(v => {
                ...
                if(v.category === 'RN1'){
                    h4_3.textContent = `${v.obsrValue}mm`;
                }
            })
        }
    ...
    btn2.addEventListener('click', function () {
        ...
        img.src = 'img/busan-night-scene-1747130_1920.jpg';
