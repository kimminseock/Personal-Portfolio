    ...
    t.fn.bxSlider = function (n) {
        ...
        if (!t(o).data("bxSlider")) {
            var l = function () {
                ...
                var e, i, n, r = t || s.settings.speed, a = {left: 0, top: 0}, l = {left: 0, top: 0};
                ...
                if (!t(e.target).is("a") && ("touchstart" === e.type || 0 === e.button)) if (e.preventDefault(), s.controls.el.addClass("disabled"), s.working) s.controls.el.removeClass("disabled"); else {
                    s.touch.originalPos = o.position();
                    var i = e.originalEvent, n = void 0 !== i.changedTouches ? i.changedTouches : [i],
                        r = "function" == typeof PointerEvent;
                    if (r && void 0 === i.pointerId) return;
                    s.touch.start.x = n[0].pageX, s.touch.start.y = n[0].pageY, s.viewport.get(0).setPointerCapture && (s.pointerId = i.pointerId, s.viewport.get(0).setPointerCapture(s.pointerId)), s.originalClickTarget = i.originalTarget || i.target, s.originalClickButton = i.button, s.originalClickButtons = i.buttons, s.originalEventType = i.type, s.hasMove = !1, s.viewport.on("touchmove MSPointerMove pointermove", R), s.viewport.on("touchend MSPointerUp pointerup", Z), s.viewport.on("MSPointerCancel pointercancel", V)
                }
            }, V = function (t) {
                ...
                var i = e.originalEvent, n = void 0 !== i.changedTouches ? i.changedTouches : [i], r = 0, a = 0;
